...
```
watch 0.8.1 (3d0715d, built 2026-09-11T23:55:59Z)
manifest 0.8.1 at /Users/you/Developer/herdr-plugin-recent-spaces/herdr-plugin.toml
...
```
fetched watch-macos-arm64-3d0715d4a1b2 from https://github.com/.../releases/download/0.8.1/watch-macos-arm64-3d0715d4a1b2
```
...
```
STALE: this binary is 0.8.1 but the manifest is 0.8.2. Rebuild it with `cargo build --release`.
```
...
```
STALE: this binary is 0.8.1 but the manifest is 0.8.2. This binary was fetched, so reinstall the plugin to get the 0.8.2 binary.
```
